...
void StartMenu::addInteractablesToMenu() {
	...
	const std::function startFunc = [this] { GameState::changeGameState(GameState::State::GameLoop); };
	...
	const std::function settingsFunc = [this] { std::cout << "opt" << '\n'; GameState::changeGameState(GameState::State::OptionsMenu); };
	...
	const std::function quitFunc = [this] { GameState::changeGameState(GameState::State::End); };
