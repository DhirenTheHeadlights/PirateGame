...
namespace PirateGame {
	class ScrollBar {
	public:
		ScrollBar(Context& context, float spacingBetweenInteractables = 0.f) noexcept : context(context), spacing(spacingBetweenInteractables) {
	...
	private:
		...
		void updateScrollBarPositions(const sf::Vector2f& menuPosition);
