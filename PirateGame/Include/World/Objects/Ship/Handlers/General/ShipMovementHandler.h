...
#include "World/Architecture/AstarAlgorithm.h"
#include "Globals/JsonLoader.h"

namespace PirateGame {
	class ShipMovementHandler {
	public:
		ShipMovementHandler(sf::Sprite& sprite, float& baseSpeed, JsonLoader* json) : baseSpeed(baseSpeed),
			sprite(sprite), json(json) {
